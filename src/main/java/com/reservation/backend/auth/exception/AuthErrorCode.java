...
public enum AuthErrorCode implements ErrorCode {
    ...
    REQUIRED_MEMBER_ID(HttpStatus.BAD_REQUEST, "인증: 회원 ID는 필수입니다."),
    REQUIRED_PASSWORD(HttpStatus.BAD_REQUEST, "인증: 비밀번호는 필수입니다."),

    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "인증: 이미 가입된 이메일입니다."),
    DUPLICATE_PHONE(HttpStatus.CONFLICT, "인증: 이미 사용 중인 휴대폰 번호입니다."),
    DUPLICATE_NICKNAME(HttpStatus.CONFLICT, "인증: 이미 사용 중인 닉네임입니다."),

    NOT_FOUND_BY_MEMBER_ID(HttpStatus.NOT_FOUND, "인증: 회원 ID에 해당하는 계정을 찾을 수 없습니다."),
    ...
    MISSING_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "인증: Refresh Token을 찾을 수 없습니다."),
    MISMATCH_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "인증: Refresh Token이 일치하지 않습니다."),
    ...
    PASSWORD_LOGIN_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "인증: 비밀번호 로그인을 사용할 수 없는 계정입니다."),
    ...
    INVALID_CURRENT_PASSWORD(HttpStatus.BAD_REQUEST, "비밀번호 변경: 현재 비밀번호가 일치하지 않습니다."),
    NEW_PASSWORD_SAME_AS_CURRENT(
            HttpStatus.BAD_REQUEST,
            "비밀번호 변경: 현재 비밀번호와 동일한 비밀번호로 변경할 수 없습니다."
    );
